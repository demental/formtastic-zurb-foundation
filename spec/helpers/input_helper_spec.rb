...
describe 'FormtasticZurbFoundation::FormBuilder#input' do
  ...
  describe 'arguments and options' do
    ...
    describe ':required option' do
      ...
      describe 'when false' do
        ...
        before(:each) do
          @orig_optional_string = FormtasticZurbFoundation::FormBuilder.optional_string
          @string = FormtasticZurbFoundation::FormBuilder.optional_string = " optional yo!" # ensure there's something in the string
          @new_post.class.should_not_receive(:reflect_on_all_validations)
        end
      
        after(:each) do
          FormtasticZurbFoundation::FormBuilder.optional_string = @orig_optional_string
        end
      ...
      describe 'when not provided' do
        ...
        describe 'and an object was not given' do
          ...
          before(:each) do
            @orig_all_fields_required = FormtasticZurbFoundation::FormBuilder.all_fields_required_by_default
          end
      
          after(:each) do
            FormtasticZurbFoundation::FormBuilder.all_fields_required_by_default = @orig_all_fields_required         
          end
      
          it 'should use the default value' do
            FormtasticZurbFoundation::FormBuilder.all_fields_required_by_default.should == true
            FormtasticZurbFoundation::FormBuilder.all_fields_required_by_default = false
    ...
    describe ':as option' do
      ...
      describe 'when not provided' do
        ...
        describe 'defaulting to file column' do
          FormtasticZurbFoundation::FormBuilder.file_methods.each do |method|
            it "should default to :file for attributes that respond to ##{method}" do
              column = mock('column')
      
              FormtasticZurbFoundation::FormBuilder.file_methods.each do |test|
      ...
      it 'should call the corresponding input class with .to_html' do
        ...
        [:select, :radio, :date, :datetime, :time, :boolean, :check_boxes, :hidden, :string, :password, :number, :text, :file].each do |input_style|
          ...
          semantic_form_for(@new_post) do |builder|
            ...
            input_constant = "FormtasticZurbFoundation::Inputs::#{input_class}".constantize
    ...
    describe ':hint option' do
      ...
      describe 'when provided' do
        ...
        before(:each) do
          @orig_hint_class = FormtasticZurbFoundation::FormBuilder.default_inline_hint_class
        end

        after(:each) do
          FormtasticZurbFoundation::FormBuilder.default_inline_hint_class = @orig_hint_class
        end
        ...
        it 'should have a custom hint class defaulted for all forms' do
          hint_text = "this is the title of the post"
          # FormtasticZurbFoundation::FormBuilder.default_hint_class = "custom-hint-class"
          FormtasticZurbFoundation::FormBuilder.default_inline_hint_class = "custom-hint-class"
          concat(semantic_form_for(@new_post) do |builder|
            concat(builder.input(:title, :hint => hint_text))
          end)
          output_buffer.should have_tag("form div.clearfix div span.custom-hint-class", hint_text)
  ...
  describe 'instantiating an input class' do
    ...
    context 'when a customized top-level class does not exist' do
      ...
      it 'should instantiate the Formtastic input' do
        ...
        FormtasticZurbFoundation::Inputs::StringInput.should_receive(:new).and_return(input)
        concat(semantic_form_for(@new_post) do |builder|
    ...
    describe 'when a top-level input class exists' do
      it "should instantiate the top-level input instead of the Formtastic one" do
        class ::StringInput < FormtasticZurbFoundation::Inputs::StringInput
        end
    
        input = mock('input', :to_html => 'some HTML')
        FormtasticZurbFoundation::Inputs::StringInput.should_not_receive(:new).and_return(input)
